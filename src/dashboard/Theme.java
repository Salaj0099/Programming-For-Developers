...
public final class Theme {
    ...
    public static final Color HEADER_BG = new Color(0x1E, 0x2A, 0x44);
    public static final Color HEADER_TEXT = Color.WHITE;
    public static final Color HEADER_SUBTEXT = new Color(0xA8, 0xB4, 0xCC);

    public static final Color BTN_START = new Color(0x2E, 0x7D, 0x32);
    public static final Color BTN_STOP = new Color(0xC6, 0x28, 0x28);
    public static final Color BTN_CALC = new Color(0x1F, 0x3A, 0x93);
    ...
    public static final Color CHART_PRICE = new Color(0x1F, 0x3A, 0x93);
    public static final Color CHART_MA = new Color(0xE8, 0xA3, 0x3D);
